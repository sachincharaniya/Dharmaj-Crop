<%@ Page Language="C#" MasterPageFile="~/sitemaster.master" AutoEventWireup="true" CodeFile="plantgrowth1.aspx.cs" Inherits="plantgrowth1" Title="Untitled Page" %>
...
&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [plantgrowth] WHERE ([productID] = @productID)">
        <SelectParameters>
